...
return $form_fields = array(
    ...
    'show_paypal_credit' => array(
        ...
        'default' => 'yes',
        'description' => ($this->is_us) ? "" : __('Currently disabled because PayPal Credit is only available for U.S. merchants.', 'express-checkout'),
    ),
    ...
    'debug' => array(
        'title' => __('Debug', 'express-checkout'),
        'type' => 'checkbox',
        'label' => __('Enable logging <code>/wp-content/uploads/wc-logs/paypal_express-{tag}.log</code>', 'express-checkout'),
        'default' => 'no'
    ),
);