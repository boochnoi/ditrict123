...
if ( !class_exists( 'FME_Registration_Attributes_Front' ) ) { 
	...
	class FME_Registration_Attributes_Front extends FME_Registration_Attributes {
		...
		">by <a style="color: #9b9b9b;" rel="dofollow" target="_Blank" href="https://www.fmeaddons.com/woocommerce-plugins-extensions/customer-registration-plugin.html">Fmeaddons</a></p>  </div>
