...
class WC_SA
{
    ...
    public function add_options()
    {
        ...
        add_option('trigger_options', $trigger_options);
    }
    ...
    public function admin_enqueue_styles($hook = '')
    {
        ...
        if ($screen->id == 'woocommerce_page_wc-settings') {
            ...
            wp_enqueue_style('wc_sa_datepicker_style', esc_url($this->assets_url) . 'plugins/MultiDatesPicker/css/pepper-ginder-custom.css', array('jquery-ui-style'));
        }
    ...
    public function admin_enqueue_scripts($hook = '')
    {
        ...
        if ($screen->id == 'woocommerce_page_wc-settings') {
            ...
            wp_enqueue_script('wc_sa_settings_script', esc_url($this->assets_url) . 'js/settings.js', array('jquery', 'jquery-ui-core'));
        }
